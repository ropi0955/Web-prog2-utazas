<div class="page-heading about-heading header-text" style="background-image: url(assets/images/airport.jpg);">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="contact-form">
              <form action="beleptet" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                      <button type="submit" value="Küldés" class="btn-outline-success">Belépés</button>
                    </fieldset>
                  </div>
